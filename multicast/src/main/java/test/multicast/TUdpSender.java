...
public class TUdpSender {
    private static final String TAG = "TUdpSender";
    ...
    public TUdpSender(Activity AContext) {
        wifiManager = (WifiManager) AContext.getApplicationContext().getSystemService(AContext.WIFI_SERVICE);
    }
